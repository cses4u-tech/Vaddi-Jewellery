...
export const VaddiCalculatorModal: React.FC<VaddiCalculatorModalProps> = ({
  ...
  const [goldWeightGrams, setGoldWeightGrams] = useState<number>(16); // 2 pavans
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <div className="lg:col-span-7 bg-white rounded-xl p-5 border border-stone-200 shadow-xs space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-stone-700 mb-1">Gross Weight (Grams)</label>
                    <div className="relative">
                      <input
                        type="number"
                        step="0.01"
                    ...
                    <span className="text-[10px] text-stone-500 mt-1 block">
                      ≈ {(goldWeightGrams / 8).toFixed(2)} Pavans / {(goldWeightGrams / 11.66).toFixed(2)} Tolas
                    </span>
                  </div>
                </div>
