...
export const DEFAULT_PRODUCTS: Product[] = [
  // Gold Products
  {
    ...
    price: 497210, // (62.4*7020) + 12% + 6500
    show_price: 1,
  ...
  },
  {
    id: 11,
    code: 'VD-S003',
    title: 'Sterling Silver Royal Pooja Thali Set (8 Pieces)',
    title_te: 'రాయల్ 92.5 వెండి పూజా తాంబూలం సెట్ (8 వస్తువులు)',
    metal: 'Silver',
    category: 'Silver Pooja Thali Sets',
    category_te: 'వెండి పూజా తాంబూలం సెట్లు',
    product_type: 'Pooja Article',
    purity: '92.5 Sterling Silver',
    description: 'Complete 8-piece 92.5 silver royal pooja set: 11-inch engraved pooja thali, 2 Kamakshi diyas, silver kalash, kumkum katori, chandan katori, and silver pooja bell.',
    ...
    image_paths: ['/images/jewellery/vd_s003_silver_pooja_thali_set.svg']
  },
  {
    id: 12,
    code: 'VD-S004',
    ...
    image_paths: ['/images/jewellery/vd_s004_silver_kalash_nariyal.svg']
  },
  {
    id: 13,
    code: 'VD-S005',
    ...
    image_paths: ['/images/jewellery/vd_s005_silver_payal_anklets.svg']
  },
  {
    id: 14,
    code: 'VD-S006',
    ...
    image_paths: ['/images/jewellery/vd_s006_silver_kamakshi_diya.svg']
  }
];
